...
<body>
    ...
    <div class="table-responsive">
        <h3 class="mb-4">Them san pham</h3>
        <table class="table">
            <form method="POST" action="quanlysp/xuly.php" enctype="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><textarea cols="40" name="mota" style="resize: none;"></textarea></td>
                    ...
                    <tr>
                        <td collapse="2"><input type="submit" name="themsp" value="Thêm sản phẩm">
                        </td>
                    </tr>
                </tbody>
            </form>
