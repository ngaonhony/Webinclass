<?php
$code = $_GET['code'];
$sql_lietke_dh = "SELECT * FROM ordersdetail,product,orders WHERE ordersdetail.orderid=orders.orderid AND ordersdetail.productid=product.productid AND ordersdetail.orderid='$_GET[code]' ORDER BY ordersdetail.orderdtid DESC";
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        if($row['status'] == 1){?>
                                            <td>
            <a href="quanlydonhang/xoahoadon.php?xoa=<?php echo $row['orderid'] ?>"><i class="fa-solid fa-trash-can"></i></a>
        </td> <?php } ?>
